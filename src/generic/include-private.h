#ifndef mulle_objc_plist_foundation_include_private_h__
#define mulle_objc_plist_foundation_include_private_h__
...
#include "_MulleObjCPlistFoundation-include-private.h"
